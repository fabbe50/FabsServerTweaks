...
loom {
    accessWidenerPath = rootProject.file("src/main/resources/fabsservertweaks.accesswidener")
    ...
    if (loader == "forge") {
        forge.mixinConfigs(
            "fabsservertweaks-common.mixins.json",
            "fabsservertweaks-forge.mixins.json",
        )
    }
}
