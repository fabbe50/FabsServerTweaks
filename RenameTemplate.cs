...
{
    //ORDER MATTERS
    new { Old = "com.example", New = "com.fabbe50.fabsservertweaks" }, //change mod package
    new { Old = "template", New = "fabsservertweaks" }, //change modid
    new { Old = "Template", New = "Fab's Server Tweaks" }, //change mod display name
    //               ↕ <- Letter L is different case here
    new { Old = "TempLate", New = "FabsServerTweaks" }, //change mod init class and other places where mod name is in PascalCase
    new { Old = "AuthorExample", New = "fabbe50" }
};
