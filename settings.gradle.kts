...
stonecutter {
    ...
    shared {
        ...
        //i would recommend to use neoforge for mc > 1.20.1, i haven't tested fabsservertweaks for forge on versions higher than that
...
rootProject.name = "FabsServerTweaks"